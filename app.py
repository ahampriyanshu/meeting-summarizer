...
from src.meeting_agent import MeetingAgent
...
def main():
    ...
    st.markdown("Automatically extract action items, agenda, and key information from meetings")
...
Bob: Sure, I'll review it today.""",
        "Sample 2: Planning Meeting": """We need to finalize the Q2 roadmap today. The team agreed to prioritize 
...
the launch campaign.""",
        "Sample 3: Bug Fix Sync": """Quick sync on the bug fixes. Mike said the critical login bug is 
...
performance issue, expects to have it done by end of week."""
    ...
    default_text = sample_transcripts[selected_sample]
            ...
            if not transcript or not transcript.strip():
                ...
                with st.spinner("Analyzing meeting transcript..."):
                    try:
                        ...
                        st.info("Please implement the `summarize_meeting()` method in `src/meeting_agent.py`")
                    except Exception as e:
