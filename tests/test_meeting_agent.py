...
class TestMeetingAgent:
    ...
    def test_agent_implemented(self):
        ...
        try:
            ...
            pytest.fail("Candidate must implement summarize_meeting() method in src/meeting_agent.py")
    ...
    def test_case_1_standup(self):
        ...
        assert evaluation['pass'], f"Test failed: {evaluation.get('feedback', 'No feedback')}"
